            ...
            <div className="menu2 container-fluid">
              <div className="row">
                ...
                <div className="menu2-detail col-md-9">                 
                  { detail.routes.map((item, index) => <NavLink key={index} to={item.subroute[0].path} > {item.title} </NavLink>)}
                </div>
              </div>
            </div>
        );
